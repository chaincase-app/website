...
<% set_meta_tags title: 'Interactive Transactions with PSBT', description: 'PSBT history and the forecast for PSBT2', og: { image: image_url('psbt-scaffold.jpg') } %>
...
**Thanks** to Nick Farrow for reading drafts of this.
